...
public class DriveConstant {
    public static double ENCODER_COUNTS_PER_REVOLUTION = 3.3;     //@TODO Test and find the number of encoder counts for 1 revolution

    public static double ODOMETRY_RAD = 2.9;    //in cm
    public static double MECANUM_RAD = 5.0;     //in cm
