...
public class OdometerIMU2W extends Odometer{
    ...
    */
    ...
    private double horizontalOffset = -16.1;
    private double verticalOffset = -6.24;
    ...
    public OdometerIMU2W(RobotHardware robotHardware){
    ...
    public void update(){
        ...
        positionChangeHorizontal[1] = Math.cos(headingChange) * verticalExtra;
        positionChangeHorizontal[0] = Math.sin(headingChange) * verticalExtra;
