...
@Autonomous(name = "AutoVufCrater", group = "Autonomous")
@Disabled
public class AutoVufCrater extends LinearOpMode {
        ...
        while (analyze) {
            ...
            switch (goldPos) {
                case "left":
                    ...
                    sleep(850);
                    robot.brake();
                    drive(0.5, 2800);//encloses cube
                    robot.brake();
                    sleep(500);
                    telemetry.addData("FLAG", "DOWN");
                    telemetry.update();
                    robot.swing(robot.getSwingDown()); //down
                    sleep(500);
                    robot.brake();
                    sleep(400);
                    robot.drive(0.5);
                ...
                case "center":
                    ...
                    telemetry.update();
                    sleep(1000);
                    robot.swing(robot.getSwingDown());
                    robot.drive(0.5);
                    sleep(2500);//6000 for full field
                    robot.brake();
                    analyze = false;
                    break;
                case "right":
