 ...
 */
public abstract class OmniAutoClassTest extends LinearOpMode {
    ...
    public static float mmPerInch = OmniAutoClassTest.MM_PER_INCH;
...
//        robot.rotator2.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public void driveAtHeading(double speed, double rotateSpeed, double driveAngle, double headingAngle) {
        ...
        robot.drive(xPower, yPower, rotateSpeed, -90.0, false);
    }
     ...
     * @param driveAngle   - The angle of movement to drive the robot
     * @param headingAngle - The heading angle to hold while driving
     * @param driveTime    - The amount of time to drive
     */
    public void driveAtHeadingForTime(double speed, double rotateSpeed, double driveAngle, double headingAngle, double driveTime) {
     ...
     */
    public void rotateRobotToAngle(double speed, double targetAngle, double maxTime) {
        double gyroReading = robot.readIMU();
...
//            rangeValue = robot.readRangeSensor();
    ...
    public void Land() {
        double endTime = timer.milliseconds() + 5000.0;
//        robot.startLifterUp();
//        while((robot.lifter.isBusy()) && (timer.milliseconds() <= endTime) && (!isStopRequested()));
//        robot.stopLifter();
...
//            robot.setRightCollectorPower(0.0);
            ...
            driveAtHeadingForTime(0.2, 0.1, 43, 43, 2000);
...
//            robot.setRightCollectorPower(0.0);
            ...
            driveAtHeadingForTime(0.2, 0.05, 43, 43, 2000);
        } else {
...
//            robot.setRightCollectorPower(0.0);
            ...
            driveAtHeadingForTime(0.4, 0.05, 43, 43, 850);
        }
    }
    ...
    void sampleCrater(int position) {
        ...
        if(position == POSITION_LEFT) {
            ...
            driveAtHeadingForTime(slowMove, 0.05, 270, 90, 450);
...
//            robot.setRightCollectorPower(0.0);
            ...
            rotateRobotToAngle(rotateSpeed, 90.0, 5000);
            driveAtHeadingForTime(slowMove, 0.05, 270, 90, 400);
            driveAtHeadingForTime(slowMove, 0.05, 180, 90, 500);
            driveAtHeadingForTime(slowMove, 0.05, 270, 90, 450);
            driveAtHeadingForTime(slowMove, 0.05, 90, 90, 450);

            // Go to wall
            driveAtHeadingForTime(fastMove, 0.05, 0, 90, 750);
            rotateRobotToAngle(rotateSpeed, 225.0, 5000);
            driveAtHeadingForTime(slowMove, 0.05, 315, 225, 600);
            driveAtHeadingForTime(fastMove, 0.1, 43, 227, 700);
...
//            robot.setRightCollectorPower(0.0);
            ...
            driveAtHeadingForTime(fastMove, 0.1, 227, 227, 850);
        } else {
            // Lining Up
            rotateRobotToAngle(rotateSpeed, 90.0, 5000);
            driveAtHeadingForTime(slowMove, 0.05, 270, 90, 400);
