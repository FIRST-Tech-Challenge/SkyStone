...
public class intakeBlockAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        intakePath.add(new RobotPoint(0, 0, 0, 0.5));
        intakePath.add(new RobotPoint(32, 52, 21, 0.5));
        intakePath.add(new RobotPoint(30, 76, 27, 0.5));
        intakePath.add(new RobotPoint(16, 104, 32, 0.5));//This point is the final point, threshold
        RobotPoint intakePathGoal = new RobotPoint(14, 130, 20, 0.5);
        ...
        deliverPath.add(new RobotPoint(30, 95, 20, 0.7));
        deliverPath.add(new RobotPoint(30, 76, 20, 0.7));
        deliverPath.add(new RobotPoint(41, 50, 70, 0.7));
        deliverPath.add(new RobotPoint(65, 47, 90, 0.7));
        deliverPath.add(new RobotPoint(122, 47, 90, 0.7));
        deliverPath.add(new RobotPoint(162, 45, 135, 0.7));
        deliverPath.add(new RobotPoint(205, 53, 180, 0.7));
        RobotPoint deliverPathGoal = new RobotPoint(205, 53, 180, 0.5);
        ...
        movement.followPath(intakePath, 30);
        ...
        telemetry.update();
        movement.followPath(deliverPath, 30);
