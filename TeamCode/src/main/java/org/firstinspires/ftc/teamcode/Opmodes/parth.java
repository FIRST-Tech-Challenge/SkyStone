...
*/
        ...
        if (skyPosition == 0) {//closest wall
            ...
            dropoffOne.add(new RobotPoint(-46, 74.5, -90, 1.0)); // at block
            //dropoffOne.add(new RobotPoint(-60, 70, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-86, 62, -90, 1.0));
            dropoffOne.add(new RobotPoint(-100, 56, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-175, 73, -90, 1.0)); // at foundation
            dropoffOne.add(new RobotPoint(-200, 79, -90, 1.0)); // at foundation
            ...
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffTwo.add(new RobotPoint(-175, 73, -90, 1.0)); // at foundation
            dropoffTwo.add(new RobotPoint(-220, 79, -90, 1.0)); // at foundation
            ...
            //dropoffThree.add(new RobotPoint(-156, 67, -90, 1.0));
            //dropoffThree.add(new RobotPoint(-165, 73, -90, 1.0)); // at foundation
            dropoffThree.add(new RobotPoint(-225, 79, -90, 1.0)); // at foundation

            ArrayList<RobotPoint> dropoffFour = new ArrayList<>();
            dropoffFour.add(new RobotPoint(18, 74.5, -90, 1.0)); // at block
            //dropoffFour.add(new RobotPoint(-30, 68, -90, 1.0)); // at block
            //dropoffOne.add(new RobotPoint(-86, 62, -90, 1.0));
            dropoffFour.add(new RobotPoint(-100, 56, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffFour.add(new RobotPoint(-165, 73, -90, 1.0)); // at foundation
            ...
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffFive.add(new RobotPoint(-155, 73, -90, 1.0)); // at foundation
            dropoffFive.add(new RobotPoint(-220, 78, -90, 1.0)); // at foundation

            ArrayList<RobotPoint> dropoffSix = new ArrayList<>();
            dropoffSix.add(new RobotPoint(56, 74.5, -90, 1.0)); // at block
            //dropoffSix.add(new RobotPoint(-46, 68, -90, 1.0)); // at block
            //dropoffOne.add(new RobotPoint(-86, 62, -90, 1.0));
            dropoffSix.add(new RobotPoint(-100, 56, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffSix.add(new RobotPoint(-155, 73, -90, 1.0)); // at foundation
            dropoffSix.add(new RobotPoint(-236, 78, -90, 1.0)); // at foundation

            // Running Actual Routine
            autoClaws.firstPrime();
            movement.moveToPointPD2(new RobotPoint(57, 72.75, -90, 0.1), 100, 1.5);
            autoClaws.grabBlock();
            ...
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-8, 75.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            ...
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-46, 76.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            ...
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-28, 78.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
        ...
        if (skyPosition == 1) {//middle
            ...
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffSix.add(new RobotPoint(-155, 73, -90, 1.0)); // at foundation
            dropoffSix.add(new RobotPoint(-220, 78, -90, 1.0)); // at foundation

            // Running Actual Routine
            autoClaws.firstPrime();
            movement.moveToPointPD2(new RobotPoint(38, 73.5, -90, 0.1), 100, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            ...
            movement.followPath(pickupBlockTwo, 16);
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-26, 75, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            movement.followPath(dropoffTwo, 15);
            autoClaws.firstDepositBlock();
            ...
            movement.followPath(pickupBlockThree, 16);
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-8, 78.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
        ...
        if (skyPosition == 2) {//furthest from wall
            ...
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffOne.add(new RobotPoint(-175, 73, -90, 1.0)); // at foundation
            dropoffOne.add(new RobotPoint(-225, 79, -90, 1.0)); // at foundation
            ...
            dropoffTwo.add(new RobotPoint(-208, 79, -90, 1.0)); // at foundation
            ...
            //dropoffOne.add(new RobotPoint(-156, 62, -90, 1.0));
            //dropoffFour.add(new RobotPoint(-165, 73, -90, 1.0)); // at foundation
            dropoffFour.add(new RobotPoint(-240, 79, -90, 1.0)); // at foundation
            ...
            // Running Actual Routine
            autoClaws.firstPrime();
            movement.moveToPointPD2(new RobotPoint(17, 73.5, -90, 0.1), 120, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            ...
            movement.followPath(pickupBlockOne, 16);
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-46, 74, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            movement.followPath(dropoffTwo, 15);
            autoClaws.firstDepositBlock();
            movement.followPath(pickupBlockTwo, 16);
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-28, 75.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            movement.followPath(dropoffTwo, 15);
            autoClaws.depositBlock();
            ...
            autoClaws.prime();
            movement.moveToPointPDBlue(new RobotPoint(-12, 77.5, -90, 0.1), 50, 1.5);
            autoClaws.grabBlock();
            autoClaws.storeBlock();
            movement.followPath(dropoffThree, 15);
            autoClaws.depositBlock();
        ...
        movement.deadReckon(0, 0.4, 0, 600);
        clampFoundation();
        movement.moveToPointConstants(new RobotPoint(-205, 30, -140, 0), 0.6, 0.5, 15, 20);
        //  movement.moveToPointConstants(new RobotPoint(234, 8, 92, 0), 0.5, 0.5, 0, 45);
        movement.pointInDirection(-90, 10);
        movement.deadReckon(-0.5, 0, 0, 300);
        releaseFoundation();
