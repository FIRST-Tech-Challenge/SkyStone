...
@Autonomous(name = "SKYSTONE-AUTO-", group = "S-Side")
public class SkyStoneAuto3 extends LinearOpMode {
    ...
    public double powerUp = 0.4, powerDown = -0.4;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        goForward(0.45);
        while(opModeIsActive()&&!tripWireActive(9.9)){
        ...
        BR.setPower(powerUp + joltControl(runtime));
