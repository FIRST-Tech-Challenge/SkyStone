...
public class BlueFront extends AutoBase {
    ...
    public void runOpMode() {
        ...
        robot.splineMove(toDepositSecondStone, 1, 1, 0.4, 35, Math.toRadians(180), Math.toRadians(90), 90,
        ...
        robot.splineMove(toDepositThirdStone, 1, 1, .4, 35, Math.toRadians(180), Math.toRadians(90), 90, toParkAfterThirdStoneActions, true, 4500, true, new Point(41, mecanumPoint + 10));
