...
public class RedFront extends AutoBase{
    ...
    public void runOpMode() {
        ...
        double[][] toDepositSecondStone = {
                ...
                {secondSkyStoneX-15,secondSkyStoneY+8,10,0},
                {22,29,0,20},
                {24,60,0,10},
                {12,66,0,10}};
        ...
        HashMap<Point,Robot.Actions> toParkAfterThirdStoneActions = new HashMap<Point,Robot.Actions>(){{
            put(new Point(23,25), Robot.Actions.EXTEND_OUTTAKE);
        ...
        robot.splineMove(toDepositSecondStone,1,1, 0.5, 14, Math.toRadians(180),Math.toRadians(270),20,
