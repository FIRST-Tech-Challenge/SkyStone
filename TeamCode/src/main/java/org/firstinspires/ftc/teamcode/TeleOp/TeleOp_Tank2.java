 ...
 *
 * This particular OpMode just executes a basic Tank Teleop for a four wheeled robot
...
@TeleOp(name = "Tank Mode 2.0 (beta)", group = "Tank Mode")
public class TeleOp_Tank2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            // Tank Mode uses both sticks to control each side. Easier to code
            // but is harder to drive straight and has less control
            ...
            if (boost) {
                ...
                drive_FL.setPower(gamepad1.left_stick_y * 0.6);
                drive_FR.setPower(gamepad1.right_stick_y * 0.6);
                drive_RL.setPower(gamepad1.left_stick_y * 0.6);
                drive_RR.setPower(gamepad1.right_stick_y * 0.6);
            }
