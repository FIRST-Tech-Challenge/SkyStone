...
public class CollectTensorflowDataPhone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            if(recognition.getLabel().equalsIgnoreCase("skystone")){
                                if(distance.contains((int) Math.round(distanceToObj))){
                                    ...
                                    width.set(val, objWidthpx);
                                } else {
                                    distance.add((int) Math.round(distanceToObj));
                                    width.add(objWidthpx);
                                }
                            }
            ...
            if(isStopRequested()){
                DriveConstant.writeSerializedObject(AppUtil.ROOT_FOLDER + "/TFOD Data/TFOD_Distances_phone.txt", distance);
                DriveConstant.writeSerializedObject(AppUtil.ROOT_FOLDER + "/TFOD Data/TFOD_Widths_phone.txt", width);
            }
        }
