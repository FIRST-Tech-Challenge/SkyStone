...
public class Robot4100Generation1_Settings {
    ...
    public static final double GRABBERSERVO_RESTPOS = 0.0;
    public static final double GRABBERSERVO_GRABPOS = 1.0;
    public static final double GRABBERROTSERVO_INSIDEPOS = 0.0;
    public static final double GRABBERROTSERVO_OUTSIDEPOS = 1.0;
}
