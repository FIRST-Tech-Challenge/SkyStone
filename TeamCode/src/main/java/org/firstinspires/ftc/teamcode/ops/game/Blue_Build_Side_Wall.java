...
@Autonomous(name="Blue_Build_Side_Wall", group="game")
//@Disabled
public class Blue_Build_Side_Wall extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.driveTrain.moveBackward(.62, -.75);
        ...
        robot.driveTrain.moveForward(.3, -.75);
