...
public class DoubleSkystoneAuto extends TTOpMode {
    //length of foudnation + distance away from wall + length of each stone before skystone (stone pos # -1 * stone length) 12 - calcs
