...
@Autonomous(name="ChadAutoTest", group="chad")
public class ChadAutoTest extends LinearOpMode {
    //
    DcMotor frontleft;
    DcMotor frontright;
    DcMotor backleft;
    ...
    public void runOpMode(){
        ...
        backleft = hardwareMap.dcMotor.get("driveRearLeft");
        backright = hardwareMap.dcMotor.get("driveRearRight");
        ...
        //
        strafeToPosition(-29.0, 0.2);
        //
        strafeToPosition(29.2, 0.2);
        //
        moveToPosition(-45.2, 0.2);
        //
    }
    //
    /*
